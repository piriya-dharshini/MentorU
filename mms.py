...
app = Flask(__name__)
app.secret_key = 'enter_ur_secret_key'
        ...
        with open('mentee.pkl','rb') as f:
            ...
            for i in data:
                if i.username==session.get('username'):
                   ...
                   break
        print(mentee.names)
        send_message(service,mentee.currentmentor.username,f'Request for meeting from mentee {mentee.names}',msg+f'mentee username:{mentee.username}')
